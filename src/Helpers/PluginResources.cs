namespace Loupedeck.NotificationHapticPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.NotificationHapticPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.NotificationHapticPlugin.Resources.Resource.txt`.
